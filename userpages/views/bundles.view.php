...
?>     
    ...
    <div class="B-Page-Head">
        <section><span>Pricing Plans</span></section>
        <section><p>Our exclusive packages are thoughtfully crafted to meet your photography and videography needs, offering tailored solutions that perfectly capture your special moments with creativity and professionalism</p></section>
    </div>

    
        <div class="maincon" id="maincon">
            <ul class="options" id="options">
            <li id="photography"><a href="#anchor">Photography</a></li>
                <li id="videography"><a href="#anchor">Videography</a></li>
                <li id="BUNDLE"><a href="#anchor">Bundle</a></li>
            </ul>
        
            <div class="pcon active" id="pcon">
                <h1>Photography session bundles</h1>
                <div class="container" >
                <?php
                generatePhotographyPackages($photography_packages_run);
                ?>
                </div>
             
            </div>
            <div class="vcon" id="vcon" >
            <!--Videography-->
        
                <h1>Videography session bundles</h1>
                <div class="container">
        
                
                <?php
                generateVideographyPackages($videography_packages_run);
                ?>
              
                </div>
            </div>
        
            <div class="mcon" id="mcon">
        
                <!--BUNDLE bundles-->
            <h1>Photo & video session bundles</h1>
            <div class="container">
        
            
            <?php
                generateBundlePackages($bundle_packages_run);
            ?>
        </div>
    </div>
</div>
        ...
        <form id="booking-form" action="#" method="POST" autocomplete="off">
            ...
            <div class="form-two form-step">
                ...
                <section class='selectFreelancersCont'>
                    ...
                    <div>
                        <label>Selected Package <span style="color:red;">*</span></label>
                        <div id="selected-package" style="padding: 10px; border: 1px solid #ccc; border-radius: 4px; background-color: #f9f9f9;">
...
<script>
    function handleBookNowClick(packageId, packageName, packagePrice) {
    ...
    selectedPackageDiv.innerHTML = `Package: ${packageName} - Price: &#x20B1; ${packagePrice.toFixed(2)}`;
    
    // Set the hidden input value to the selected package ID
